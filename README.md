...
Proje Hakkında
Akademik grup projesi için hazırladığım veritabanı sistemi. İş mantığının büyük bir kısmı, veri bütünlüğünü korumak adına SQL katmanında (Trigger / Stored Procedure) kurgulanmıştır.
